...
class Scribbler(Robot):
    ...
    def __init__(self, serialport = None, baudrate = 38400):
        ...
        if "robot" in info.keys():
            ...
            print "RESTART" # ashleyf
            self.restart()
            print "LOAD FUDGE" # ashleyf
            # ashleyf remove self.loadFudge()
